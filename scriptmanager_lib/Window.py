...
import logging
logger = logging.getLogger('scriptmanager_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by ScriptmanagerWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('ScriptmanagerWindow')
        new_object = builder.get_object("scriptmanager_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.scriptmanager")
        ...
        try:
            from scriptmanager import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for scriptmanager."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for scriptmanager."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the ScriptmanagerWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the ScriptmanagerWindow is closed."""
